...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202_1')
BEGIN
	ALTER DATABASE [PE_DBI202_1] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE_DBI202_1] SET ONLINE;
	DROP DATABASE [PE_DBI202_1];
END

GO

CREATE DATABASE [PE_DBI202_1]
GO
